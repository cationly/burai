...
public interface SVGItemResult {

    public static final double WIDTH = 46.999;

    public static final double HEIGHT = 46.999;

    public static final String CONTENT =
            "M36.854,37.92H10.147c-1.18,0-2.136,0.956-2.136,2.136s0.956,2.137,2.136,2.137h26.705c1.181,0,2.137-0.957,2.137-2.137"
                    + "S38.032,37.92,36.854,37.92z"
                    + "M7.478,21.896v5.341c0,0.885,0.718,1.603,1.602,1.603c0.885,0,1.603-0.718,1.603-1.603v-5.341"
                    + "c0-0.885-0.718-1.602-1.603-1.602C8.195,20.295,7.478,21.012,7.478,21.896z"
                    + "M12.818,19.761v7.477c0,0.885,0.718,1.603,1.603,1.603c0.884,0,1.602-0.718,1.602-1.603v-7.477"
                    + "c0-0.885-0.718-1.603-1.602-1.603C13.536,18.158,12.818,18.876,12.818,19.761z"
                    + "M18.159,17.624v9.613c0,0.885,0.718,1.603,1.603,1.603c0.884,0,1.602-0.718,1.602-1.603v-9.613"
                    + "c0-0.885-0.718-1.603-1.602-1.603C18.877,16.021,18.159,16.739,18.159,17.624z"
                    + "M44.863,4.806H2.137C0.957,4.806,0,5.763,0,6.943v26.705c0,1.18,0.957,2.137,2.137,2.137H42.91"
                    ...
                    + "M42.371,29.554c-0.213-0.214-0.499-0.301-0.777-0.271l-0.449-0.449c1.5-1.704,2.328-3.861,2.328-6.151"
